...
if (storage.health.schemaVersion !== 5) throw new Error("STORAGE_SCHEMA_CHECK_FAILED");
...
console.log("storage-container-check: schema=5 journal=wal modes=private restart=ok");
