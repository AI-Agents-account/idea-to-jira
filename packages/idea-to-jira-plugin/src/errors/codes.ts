...
export const SAFE_ERROR_CODES = Object.freeze([
  ...
  "INTERNAL_ERROR",
  "JIRA_AUTH_FAILED",
  "JIRA_CONFIRMATION_STALE",
  "JIRA_CREATE_NOT_READY",
  "JIRA_DUPLICATE_DECISION_REQUIRED",
  "JIRA_DUPLICATE_USER_DECISION_REQUIRED",
  "JIRA_RATE_LIMITED",
  "JIRA_REQUEST_FAILED",
  "JIRA_REQUIRED_ANSWER_INVALID",
  "JIRA_REQUIRED_ANSWER_MISSING",
  "JIRA_SCOPE_INVALID",
  "JIRA_SEARCH_NOT_READY",
  "JIRA_STALE_BINDING",
  "JIRA_UNAVAILABLE",
  "JIRA_UNKNOWN_RESULT",
